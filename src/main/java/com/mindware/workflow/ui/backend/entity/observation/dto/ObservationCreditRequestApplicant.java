package com.mindware.workflow.ui.backend.entity.observation.dto;
...
public class ObservationCreditRequestApplicant {
    ...
    private Double indicartor1; //Relacion cuota/ingreso efv

    private Double indicartor2; //Relacion cuota + otras / ingreso

    private Double indicartor3; //Relacion patrimonio/credito

    private Double indicartor4; //Grantia/deuda
